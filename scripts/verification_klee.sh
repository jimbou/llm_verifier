...
# Define variables
KLEE_CONTAINER_NAME="klee_container1"
...
docker cp ../intermidiate_files/klee_analysis.c $KLEE_CONTAINER_NAME:/home/klee/verification
...
rm -f ../reports/klee_results.txt
docker cp $KLEE_CONTAINER_NAME:/home/klee/klee_results.txt ../reports
docker exec $KLEE_CONTAINER_NAME /bin/sh -c "cd verification && ./run_klee.sh"
rm -f ../reports/error_report_klee.txt
docker cp $KLEE_CONTAINER_NAME:/home/klee/verification/output.txt ../reports/error_report_klee.txt
